...
function addNewNote(note, title, content) {
    // if class is not specified, use a random colour class
    if (!note) {
        note = "colour" + Math.ceil(Math.random() * 3);
    }


    // add a new note to the end of the list
    notes.append("<li><div class='" + note + "'>" +
                "<textarea class='note-title' placeholder='Untitled' maxlength='25'></textarea>" +
                "<textarea class='note-content' placeholder='Your notes here'></textarea>" +
